...
namespace EnvironmentAssessment.Common.Sspi.Buffers
{
    ...
    /// </remarks>
    internal sealed class CSecureBufferAdapter : CriticalFinalizerObject, IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        private IList<CSecureBuffer> buffers;
        ...
        /// </summary>
        private CSecureBufferDescInternal descriptor;

        /// <summary>
        /// An array of the native buffers.
        /// </summary>
        private CSecureBufferInternal[] bufferCarrier;

        /// <summary>
        /// Initializes a SecureBufferAdapter to carry a single buffer to the native api.
        /// </summary>
        /// <param name="buffer"></param>
        public CSecureBufferAdapter( CSecureBuffer buffer )
            : this( new[] { buffer } )
        {
        }
        ...
        public CSecureBufferAdapter( IList<CSecureBuffer> buffers ) : base()
        {
            ...
            this.bufferCarrier = new CSecureBufferInternal[this.buffers.Count];

            for ( int i = 0; i < this.buffers.Count; i++ )
            {
                this.bufferHandles[i] = GCHandle.Alloc( this.buffers[i].Buffer, GCHandleType.Pinned );

                this.bufferCarrier[i] = new CSecureBufferInternal();
            ...
            this.descriptor = new CSecureBufferDescInternal();
            this.descriptor.Version = CSecureBufferDescInternal.ApiVersion;

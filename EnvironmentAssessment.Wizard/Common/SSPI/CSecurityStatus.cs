namespace EnvironmentAssessment.Common.Sspi
{
    ...
    */
    ...
    /// </summary>
    public enum CSecurityStatus : uint
    {
        ...
        /// </summary>
        [CEnumString( "Authentication cycle needs to continue" )]
        ...
        /// </summary>
        [CEnumString( "Authentication cycle needs to perform a 'complete'." )]
        ...
        /// </summary>
        [CEnumString( "Authentication cycle needs to perform a 'complete' and then continue." )]
        CompAndContinue = 0x00090314,

        /// <summary>
        /// An attempt to use the context was performed after the context's expiration time elapsed.
        /// </summary>
        [CEnumString( "The security context was used after its expiration time passed." )]
        ContextExpired = 0x00090317,

        [CEnumString( "The credentials supplied to the security context were not fully initialized." )]
        CredentialsNeeded = 0x00090320,

        [CEnumString( "The context data must be re-negotiated with the peer" )]
        Renegotiate         = 0x00090321,

        // Errors
        [CEnumString( "Not enough memory.")]
        OutOfMemory         = 0x80090300,

        [CEnumString( "The handle provided to the API was invalid.")]
        InvalidHandle       = 0x80090301,

        [CEnumString( "The attempted operation is not supported")]
        Unsupported         = 0x80090302,

        [CEnumString( "The specified principle is not known in the authentication system.")]
        TargetUnknown       = 0x80090303,
        
        [CEnumString( "An internal error occurred" )]
        InternalError       = 0x80090304,

        /// <summary>
        /// No security provider package was found with the given name.
        /// </summary>
        [CEnumString( "The requested security package was not found.")]
        ...
        /// </summary>
        [CEnumString("The provided authentication token is invalid or corrupted.")]
        ...
        /// </summary>
        [CEnumString("Impersonation is not supported with the current security package.")]
        NoImpersonation     = 0x8009030B,

        [CEnumString("The logon was denied, perhaps because the provided credentials were incorrect.")]
        LogonDenied         = 0x8009030C,


        [CEnumString( "The credentials provided are not recognized by the selected security package.")]
        UnknownCredentials  = 0x8009030D,

        [CEnumString( "No credentials are available in the selected security package.")]
        NoCredentials       = 0x8009030E,

        [CEnumString( "A message that was provided to the Decrypt or VerifySignature functions was altered " +
        "after it was created.")]
        MessageAltered      = 0x8009030F,

        [CEnumString( "A message was received out of the expected order.")]
        OutOfSequence       = 0x80090310,

        [CEnumString( "The current security package cannot contact an authenticating authority.")]

namespace EnvironmentAssessment.Common.VISoap
{
    public class VirtualMachineCapability : DynamicData
	{
		...
		protected bool _swapPreservationSupported;
		...
		protected bool _settingDisplayTopologyModesSupported;
		...
		protected bool _vmfsNativeSnapshotSupported;
		protected bool _seSparseDiskSupported;
		protected bool _nestedHVSupported;
		protected bool _vPMCSupported;
		protected bool _toolsRebootPredictSupported;
		protected bool _messageBusSupported;
		protected bool? _canConnectUSBDevices;
		...
		public bool SwapPreservationSupported
		{
			get
			{
				return this._swapPreservationSupported;
			}
			set
			{
				this._swapPreservationSupported = value;
			}
		}
		...
		public bool SettingDisplayTopologyModesSupported
		{
			get
			{
				return this._settingDisplayTopologyModesSupported;
			}
			set
			{
				this._settingDisplayTopologyModesSupported = value;
			}
		}
		...
		public bool VmfsNativeSnapshotSupported
		{
			get
			{
				return this._vmfsNativeSnapshotSupported;
			}
			set
			{
				this._vmfsNativeSnapshotSupported = value;
			}
		}
		...
		public bool ToolsRebootPredictSupported
		{
			get
			{
				return this._toolsRebootPredictSupported;
			}
			set
			{
				this._toolsRebootPredictSupported = value;
			}
		}
		public bool MessageBusSupported
		{
			get
			{
				return this._messageBusSupported;
			}
			set
			{
				this._messageBusSupported = value;
			}
		}
		public bool? CanConnectUSBDevices
		{
			get
			{
				return this._canConnectUSBDevices;
			}
			set
			{
				this._canConnectUSBDevices = value;
			}
		}
	}
}

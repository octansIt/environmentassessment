namespace EnvironmentAssessment.Common.VISoap
{
    public class VirtualMachineConfigSpec : DynamicData
	{
		...
		protected string _swapDirectory;
		protected bool? _preserveSwapOnPowerOff;
		...
		protected string _messageBusQueuePattern;
		...
		public string SwapDirectory
		{
			get
			{
				return this._swapDirectory;
			}
			set
			{
				this._swapDirectory = value;
			}
		}
		public bool? PreserveSwapOnPowerOff
		{
			get
			{
				return this._preserveSwapOnPowerOff;
			}
			set
			{
				this._preserveSwapOnPowerOff = value;
			}
		}
		...
		public string MessageBusQueuePattern
		{
			get
			{
				return this._messageBusQueuePattern;
			}
			set
			{
				this._messageBusQueuePattern = value;
			}
		}

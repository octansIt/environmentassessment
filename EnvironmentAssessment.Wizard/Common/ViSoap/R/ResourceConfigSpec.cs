...
namespace EnvironmentAssessment.Common.VISoap
{
	public class ResourceConfigSpec : DynamicData
	{
		...
		protected NetworkBandwidthAllocationInfo[] _networkBandwidthAllocation;
		...
		public NetworkBandwidthAllocationInfo[] NetworkBandwidthAllocation
		{
			get
			{
				return this._networkBandwidthAllocation;
			}
			set
			{
				this._networkBandwidthAllocation = value;
			}
		}

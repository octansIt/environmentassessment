namespace EnvironmentAssessment.Common.VISoap
{
    public class HostCapability : DynamicData
	{
		...
		protected bool _vmotionEncryptionSupported;
		...
		protected bool _checkpointFtSupported;
		protected string[] _ftCompatibilityIssues;
		protected string[] _checkpointFtCompatibilityIssues;
		...
		protected bool? _advancedSystemResourcesSupported;
		...
		public bool VmotionEncryptionSupported
		{
			get
			{
				return this._vmotionEncryptionSupported;
			}
			set
			{
				this._vmotionEncryptionSupported = value;
			}
		}
		...
		public bool CheckpointFtSupported
		{
			get
			{
				return this._checkpointFtSupported;
			}
			set
			{
				this._checkpointFtSupported = value;
			}
		}
		...
		public string[] CheckpointFtCompatibilityIssues
		{
			get
			{
				return this._checkpointFtCompatibilityIssues;
			}
			set
			{
				this._checkpointFtCompatibilityIssues = value;
			}
		}
		...
		public bool? AdvancedSystemResourcesSupported
		{
			get
			{
				return this._advancedSystemResourcesSupported;
			}
			set
			{
				this._advancedSystemResourcesSupported = value;
			}
		}

namespace EnvironmentAssessment.Common.VISoap
{
    public class ClusterDasConfigInfo : DynamicData
	{
		...
		protected ClusterDasMetroHASettings _metroHASettings;
		...
		public ClusterDasMetroHASettings MetroHASettings
		{
			get
			{
				return this._metroHASettings;
			}
			set
			{
				this._metroHASettings = value;
			}
		}

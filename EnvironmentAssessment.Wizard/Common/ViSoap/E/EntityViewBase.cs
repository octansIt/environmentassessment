...
namespace EnvironmentAssessment.Common.VISoap
{
	...
	{
		public EntityViewBase(VimClient client, ManagedObjectReference moRef) : base(client, moRef)
		{
		}
		...
		public static PropertyFilterSpec GetSearchFilterSpec(VimClient client, ManagedObjectReference beginEntity, PropertySpec propSpec)
		{
		...
		public TaskHistoryCollector GetTaskCollectorView(TaskFilterSpecRecursionOption recursionOption, TaskFilterSpec taskFilterSpec)
		{
			...
			TaskManager taskManager = (TaskManager)this.Client.GetView(this.Client.ServiceContent.TaskManager, null);
			ManagedObjectReference moRef = taskManager.CreateCollectorForTasks(taskFilterSpec);
		...
		public EventHistoryCollector GetEventCollectorView(EventFilterSpecRecursionOption recursionOption, EventFilterSpec eventFilterSpec)
		{
			...
			EventManager eventManager = (EventManager)this.Client.GetView(this.Client.ServiceContent.EventManager, null);
			ManagedObjectReference moRef = eventManager.CreateCollectorForEvents(eventFilterSpec);

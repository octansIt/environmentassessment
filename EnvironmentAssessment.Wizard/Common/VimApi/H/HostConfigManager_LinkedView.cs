namespace EnvironmentAssessment.Common.VimApi
{
	public class HostConfigManager_LinkedView
	{
		...
		public MessageBusProxy MessageBusProxy
		{
			get
			{
		...
		public HostAccessManager HostAccessManager
		{
			get
			{
		...
		public HostCertificateManager CertificateManager
		{
			get
			{

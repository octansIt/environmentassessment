namespace EnvironmentAssessment.Common.VimApi
{
	public class HostConfigInfo : DynamicData
	{
		...
		protected HostDeploymentInfo _deploymentInfo;
		...
		protected byte[] _scriptCheckSum;
		protected byte[] _hostConfigCheckSum;
		...
		protected HostIoFilterInfo[] _ioFilterInfo;
		protected HostSriovDevicePoolInfo[] _sriovDevicePool;
		...
		public byte[] ScriptCheckSum
		{
			get
			{
				return this._scriptCheckSum;
			}
			set
			{
				this._scriptCheckSum = value;
			}
		}
		public byte[] HostConfigCheckSum
		{
			get
			{
				return this._hostConfigCheckSum;
			}
			set
			{
				this._hostConfigCheckSum = value;
			}
		}
		...
		public string[] SharedPassthruGpuTypes
		{
			...
			set
			{
				this._sharedPassthruGpuTypes = value;
			}
		}
		...
		public HostIoFilterInfo[] IoFilterInfo
		{
			get
			{
				return this._ioFilterInfo;
			}
			set
			{
				this._ioFilterInfo = value;
			}
		}
		public HostSriovDevicePoolInfo[] SriovDevicePool
		{
			get
			{
				return this._sriovDevicePool;
			}
			set
			{
				this._sriovDevicePool = value;
			}
		}

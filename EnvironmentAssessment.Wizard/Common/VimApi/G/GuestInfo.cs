namespace EnvironmentAssessment.Common.VimApi
{
	public class GuestInfo : DynamicData
	{
		...
		public bool? GuestKernelCrashed
		{
			get
			{
				return this._guestKernelCrashed;
			}
			set
			{
				this._guestKernelCrashed = value;
			}
		}
		...
		public bool? GuestStateChangeSupported
		{
			get
			{
				return this._guestStateChangeSupported;
			}
			set
			{
				this._guestStateChangeSupported = value;
			}
		}

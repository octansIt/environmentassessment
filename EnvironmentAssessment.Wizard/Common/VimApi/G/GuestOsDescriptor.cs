namespace EnvironmentAssessment.Common.VimApi
{
	public class GuestOsDescriptor : DynamicData
	{
		...
		protected bool _supportsHotPlugPCI;
		protected bool? _supportsSecureBoot;
		protected bool? _defaultSecureBoot;
		public string Id
		{
			get
			{
		...
		public bool SupportsHotPlugPCI
		{
			get
			{
				return this._supportsHotPlugPCI;
			}
			set
			{
				this._supportsHotPlugPCI = value;
			}
		}
		public bool? SupportsSecureBoot
		{
			get
			{
				return this._supportsSecureBoot;
			}
			set
			{
				this._supportsSecureBoot = value;
			}
		}
		public bool? DefaultSecureBoot
		{
			get
			{
				return this._defaultSecureBoot;
			}
			set
			{
				this._defaultSecureBoot = value;
			}
		}
	}
}

namespace EnvironmentAssessment.Common.VimApi
{
	public class VMwareVspanSession : DynamicData
	{
		...
		protected string _encapType;
		protected int? _erspanId;
		protected int? _erspanCOS;
		protected bool? _erspanGraNanosec;
		public string Key
		{
			get
			{
		...
		public int? ErspanId
		{
			get
			{
				return this._erspanId;
			}
			set
			{
				this._erspanId = value;
			}
		}
		public int? ErspanCOS
		{
			get
			{
				return this._erspanCOS;
			}
			set
			{
				this._erspanCOS = value;
			}
		}
		public bool? ErspanGraNanosec
		{
			get
			{
				return this._erspanGraNanosec;
			}
			set
			{
				this._erspanGraNanosec = value;
			}
		}
	}
}

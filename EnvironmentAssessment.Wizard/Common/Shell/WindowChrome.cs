...
namespace EnvironmentAssessment.Common.Shell
{
	public class WindowChrome : Freezable
	{
		...
		public WindowChrome()
		{
			foreach (WindowChrome._SystemParameterBoundProperty current in WindowChrome._BoundProperties)
			{
				BindingOperations.SetBinding(this, current.DependencyProperty, new Binding
				{
					Source = SystemParameters2.Current,
					Path = new PropertyPath(current.SystemParameterPropertyName, new object[0]),
